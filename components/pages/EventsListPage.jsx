...
function EventModal({ event, meta, lang, onClose }) {
        ...
        <div className="relative aspect-[16/10] bg-[#111] sm:aspect-[16/9]">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              >
                {eventCategories[lang][event.category]}
              </span>
                  ...
                  >
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      <button
                        ...
                        onClick={() => setYear("all")}
                        className={`rounded-full px-3 py-1.5 text-xs font-bold ${
                          year === "all" ? "bg-[#4b0102] text-white" : "bg-[#e9f7f0] text-[#113927]"
                        }`}
                      >
                        {meta.filterAll}
                      </button>
...
function EventCard({ event, lang, cats, meta, onOpen, large = false, index }) {
  const accent = eventCategoryAccent[event.category];
  const title = event.title[lang];
