...
export default function DashboardPortfolioPage() {
  ...
  const filteredPortfolios = portfolios.filter((portfolio) => {
    const plainTextDesc = getPlainTextFromLexicalJson(portfolio.description);
    const matchesSearch =
        ...
        <AnimatePresence mode="wait">
          {!isEditorOpen ? (
            ...
            >
              ...
              {/* Form Element */}
              <form onSubmit={handleSavePortfolio} className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                ...
                <div className="lg:col-span-8 bg-white dark:bg-gray-800 rounded-lg p-6 md:p-8 border border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
                  ...
                  <div className="space-y-2 pt-2 flex flex-col">
                    ...
                    <RichTextEditor
                      key={editingPortfolio ? editingPortfolio.id : "new"}
                      value={description}
